...
def main
  ...
  i = -1
  while i < 0
    puts "What would you like to do? (list planets, planet details, add planet, distance between planets, or exit)"
    ...
    elsif answer == "distance between planets"
      puts solar_system.distance_between
    elsif answer == "exit"
      i = 1
    end
  end
